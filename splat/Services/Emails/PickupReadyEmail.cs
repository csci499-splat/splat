...
{
    public class PickupReadyEmail : EmailBase
    {
        public PickupReadyEmail(Pickup pickup, EmailExchangeOptions options) :
            base(pickup, options)
        { }
        ...
        public override string GetMessageBody()
        {
            ...
            body.Append("<h3>Your requested items are ready to be picked up:</h3>");
